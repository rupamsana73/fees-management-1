...
urlpatterns = [
    ...
    path("notifications/", views.notification_history, name="notification-history"),
    path("notifications/<int:pk>/retry/", views.notification_retry, name="notification-retry"),
